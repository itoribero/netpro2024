// 最終課題に向けてバーを左右に移動できるようにしました。
// A,Dキーで左右に移動できますが、動くまでにラグがあるため今後改善していきます。
...
public class SwingAnimationFaceObj extends JPanel implements ActionListener{
    ...
    PlayerBar bar = new PlayerBar(200, 400, 100, 30, 4);
     ...
     *操作できるバー
     */
    public class PlayerBar extends KeyAdapter implements MouseListener{
        int posX;
        int posY;
        int sizeX;
        int sizeY;
        ...
        public PlayerBar(int posX, int posY, int sizeX, int sizeY, int velocity){
            this.posX = posX;
            this.posY = posY;
            this.sizeX = sizeX;
            this.sizeY = sizeY;
